...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://sfc-repo.snowflakecomputing.com/snowsql/bootstrap/1.3/linux_x86_64/snowflake-snowsql-${version}-1.x86_64.rpm";
    sha256 = "sha256-TvF/6NPrks82nUrUYlhT2TlyicG8w1Ch9xny0Q1s1Io=";
  };
